...
\begin{frame}
 ...
 \begin{itemize}
  ...
  lowest conduction (CB) and the three uppermost valence bands (VBs) are expored based on the calculated energy bands. 
...
\begin{frame}
 ...
 \item Better analyze the impact on DOS as well as carrier concentration taking into account the non-parabolicity of the energy bands.
  ...
  \item DOS and carrier concentration obtailed by full band parameterization and parabolic band approximation are compared. 
 \end{itemize}
\end{frame}
...
%\begin{columns}[c]
%\column{2in}
DFT-based modelling is extremely successful in many-body systems.
...
\begin{frame}
\frametitle{Result 1: Parabolic band approximation (pba)}
...
It is valid in the very vicinity of the $\Gamma$-point. However, away from the $\Gamma$-point, the parabolic approximation fails to describe the energy dispersion for the CIGS.
\end{frame}


\begin{frame}
 \frametitle{Result 1: Full band parameterization (fbp)}
\begin{equation}
\begin{split}
...
\begin{frame}
 \frametitle{Result 1: Parameterization of band structure for CIGS}
  \begin{figure}
\centering
\begin{minipage}{.5\textwidth}
  \centering
...
\begin{frame}
  \frametitle{Result 1: Non-parabolicity of the energy bands}
...
\subsection{Analysis of density-of-states (DOS) and carrier concentration}

\begin{frame}
   \frametitle{Result 1: Density-of-states (DOS)}
...
\begin{frame}
  \frametitle{Result 1: Density-of-states (DOS) and DOS mass}
 \begin{figure}
\centering
\begin{minipage}{.5\textwidth}
  \centering
...
\begin{frame}
  \frametitle{Result 1: Band-gap, Fermi energy and intrinsic carrier concentration}
...
\begin{frame}[fragile] 
  \frametitle{Result 1: Carrier concentration in $p$-type for CIGS}
...
\begin{frame}
  \frametitle{Result 2: Dielectric function for CuIn\textsubscript{0.5}Ga\textsubscript{0.5}Se\textsubscript{2}}
...
\begin{figure}
  ...
  \caption{\scriptsize{Energies of each interband critial point (CP) are indicated by arrows and labeled in a numeric and alphabetic order.}}
\end{figure}
\captionsetup{width=1\linewidth}
...
\begin{frame}
  \frametitle{Result 2: Analysis of the imaginary part of dielectric function}
