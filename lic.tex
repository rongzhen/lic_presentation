...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{\scriptsize{ Electronic band structure along four directions. The circles are the results of the fbp, the dotted lines represent the pba, and the solid lines represent the theoretical calculation.}}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{\scriptsize{Close-up of the right figure.}}
  \label{fig:test2}
\end{minipage}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  ...
  \captionof{figure}{\scriptsize{Close-up of electronic band structure. The circles are the results of the fbp, the dotted lines represent the pba, and the solid lines represent the theoretical calculation.}}
  \label{fig:test1}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
